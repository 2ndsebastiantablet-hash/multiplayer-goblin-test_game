...
function App() {
  ...
  const [planet, setPlanet] = useState({ name: 'Custom Planet', terrain: 'green_hills', flora: 'normal_trees', atmosphere: 'clear_blue_sky' });
  ...
  function createPlanet() { setSavingPlanet(true); send({ type: 'createPlanet', world: planet }); }
