...
function App() {
  ...
  const [planet, setPlanet] = useState({ name: 'Custom Planet', terrain: 'green_hills', flora: 'normal_trees', atmosphere: 'clear_blue_sky', colors: DEFAULT_COLORS });
  ...
  function createPlanet() { send({ type: 'createPlanet', world: planet }); setPlanetOpen(false); }
  function loadPlanet(id) { send({ type: 'loadPlanet', worldId: id }); setPlanetOpen(false); }
